      ...
      <div class="grid grid-cols-12 divide-x">
        <div class="col-span-2">
          ...
          <nav>
            ...
            <ul class="my-5">
              <li
                class="flex items-center hover:bg-gray-100 p-3 rounded-lg my-3"
              >
                <svg
                  class="mx-2"
                  width="16"
                ...
                <span class="mx-2 text-sm text-gray-400">Dashboard</span>
              </li>
              <li
                class="flex items-center hover:bg-gray-100 p-3 rounded-lg my-3"
              >
                ...
                <span class="mx-2 text-sm text-gray-400">Users</span>
              </li>
              <li
                class="flex items-center hover:bg-gray-100 p-3 rounded-lg my-3"
              >
                ...
                <span class="mx-2 text-sm text-gray-400">Sales</span>
              </li>
            </ul>
          </nav>
        </div>
        <div class="col-span-10 px-6">
          <div class="flex items-center">
           <div class=" w-2/5">
            <div
            class=" relative flex items-center my-8 focus-within:text-red-600 focus-within:drop-shadow-lg"
          >
            <svg
              class="absolute right-5 content-end pointer-events-none"
              width="17"
              height="17"
              viewBox="0 0 17 17"
              fill="none"
           ...
           <div class="mx-6">
            ...
            <div class="mx-6">
              <img src={Person} class=" inline w-10 h-10 rounded-full" alt=""  />  
            </div>
          ...
          {/* Table Start */}
          <p class="text-2xl font-semibold"> User List</p>

          <table class="table-auto w-full text-center p-3">
            <thead class="bg-gray-100 rounded-lg">
              <tr class="">
                <th class="rounded-md p-3">#ID</th>
                <th class="rounded-md p-3">USER</th>
                <th class="rounded-md p-3">EMAIL</th>
                <th class="rounded-md p-3">OPTIONS</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="p-3">1</td>
                <td class="p-3"> 
                <img src={Person} class=" inline w-16 h-16 rounded-lg" alt=""  /> 
                  Michael Lawson
                </td>
                <td class="p-3">michael.lawson@reqres.in</td>
                <td class="p-3 flex justify-center items-center"> 
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.40002 14.4C3.72551 14.4 4.80003 13.3255 4.80003 12C4.80003 10.6745 3.72551 9.59998 2.40002 9.59998C1.07452 9.59998 0 10.6745 0 12C0 13.3255 1.07452 14.4 2.40002 14.4Z" fill="#B0B7C3"/>
                    <path d="M12 14.4C13.3255 14.4 14.4 13.3255 14.4 12C14.4 10.6745 13.3255 9.59998 12 9.59998C10.6745 9.59998 9.59998 10.6745 9.59998 12C9.59998 13.3255 10.6745 14.4 12 14.4Z" fill="#B0B7C3"/>
                    <path d="M21.6 14.4C22.9255 14.4 24 13.3255 24 12C24 10.6745 22.9255 9.59998 21.6 9.59998C20.2745 9.59998 19.2 10.6745 19.2 12C19.2 13.3255 20.2745 14.4 21.6 14.4Z" fill="#B0B7C3"/>
                    </svg>
