  ...
  return (
    <div>
      <header className="flex justify-between items-center my-4">
        ...
        <div>
          <div className="bg-slate-200 flex justify-between items-center rounded-full px-4 py-2">
      ...
      <section className="my-20">
        <div className="flex justify-center">
          <div>
            ...
            <div className="flex justify-center">
              <button className="bg-slate-100 flex justify-between items-center rounded-lg mx-3 px-4 py-2">
                <svg
                  className="mx-3"
                  width="25"
                  height="25"
            ...
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className=" h-4 w-4 border-solid border-2 border-indigo-600  rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"
              />
              <label
                htmlFor="remember-me"
                className="ml-2 block text-sm text-gray-400 text-medium"
              >
                Remember me
              </label>
            </div>
            <button className="bg-blue-500 rounded-xl mx-3 w-full text-center my-5 px-4 py-4 text-base text-white font-medium hover:bg-blue-600">
              Sign In
            </button>
