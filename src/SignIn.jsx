    ...
    <div> 
        ...
        <section class="my-20">
          <div class="flex justify-center">
            <div>
              <p class="text-center font-bold text-2xl ">Sign In</p>
              ...
              <div class="flex items-center">
                ...
                <label for="remember-me" class="ml-2 block text-sm text-gray-400 text-medium">Remember me</label>
              </div>
              <button
                ...
                <p class="text-center text-base font-medium text-lg text-gray-400 my-5">
                  Don't have an account yet? <a href="#" class="text-blue-500">Sign Up</a>
                </p>
